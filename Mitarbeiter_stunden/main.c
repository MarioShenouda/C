...
int main()
{
    ...
    */
    ...
    while(1)
    {
        ...
        case '2':
            ...
            {
                printf("\n%s \t%s ",e.name,e.time); /// print the name, age and basic salary
            }
            getch();
            break;
  ...
  /* time_t t;   // not a primitive datatype
   ...
   fgets(employer_name,20,stdin);

   printf("you sigined in %s",ctime(&t));
